CUDA_VISIBLE_DEVICES=0 python test.py --gpus 1 --model drn --name SPARNet_S16_V4_Attn2D \
    --load_size 128 --dataset_name single --dataroot "/home2/ZiXiangXu/Last_ding/spation_test_1000/" \
    --pretrain_model_path "/home2/ZiXiangXu/Last_ding/res4/PSNR_28.37.pth" \
    --save_as_dir "/home2/ZiXiangXu/Last_ding/res4/epoch_CelebA/"
