...
from models.ctcnet import CTCNet


class CTCNetModel(BaseModel):
    ...
    def backward_G(self):
        # Pix loss
        #self.loss_Pix1 = self.criterionL1(self.out1, self.img_HR) * self.opt.lambda_pix
        self.loss_Pix = self.criterionL1(self.img_SR, self.img_HR) * self.opt.lambda_pix
        #self.loss_Pix = self.loss_Pix + self.loss_Pix1
